...
{
	public static var monoEngineVersion:String = '0.1.1'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Mono Engine v" + monoEngineVersion, 12);
